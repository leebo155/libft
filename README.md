...
| ft_memcpy | void * | void *dst: The memory area to be copied.<br><br>const void *src: The memory area to copy.<br><br>size_t len: The length of 'dst' to be copied. | Copies 'n' bytes from 'src' to 'dst' and returns 'dst'. |
